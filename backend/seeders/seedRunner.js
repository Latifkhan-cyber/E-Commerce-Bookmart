...
const seedData = async () => {
  try {
    ...
    if (bookCount > 0) {
      console.log(`Database already populated with ${bookCount} books. Skipping auto-seed.`);
      return;
    }
    ...
    console.log('Database auto-seeded with 20 books and default accounts successfully!');
  } catch (error) {
